...
uses
  ...
  Oracle, OracleData, OracleVarEdit, OraclePreferences, OracleQB;
{$ELSE}
uses
  ...
  Oracle, OracleData, OracleVarEdit, OraclePreferences;
{$ENDIF}
...
type
  TSQLEditForm = class(TForm)
    ...
    procedure SQLEditScriptCommand(Sender: TOracleScript;
      var Handled: Boolean);
