...
uses
  ...
  StdCtrls, OracleTypes, Oracle, ExtCtrls, OraclePreferences;
{$ELSE}
uses
  Variants, SysUtils, Classes, QGraphics, QControls, QForms, QDialogs,
  QStdCtrls, OracleTypes, Oracle, OraclePreferences, QExtCtrls;
{$ENDIF}
...
function  ExecuteVariablesEditor(Q: TOracleQuery): Boolean;
...
procedure TVariablesForm.FormActivate(Sender: TObject);
begin
