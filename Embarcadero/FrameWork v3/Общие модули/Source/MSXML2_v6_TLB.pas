...
// File generated on 27.08.2020 18:02:18 from Type Library described below.
...
//   Error creating palette bitmap of (TDOMDocument60) : Invalid GUID format
//   Error creating palette bitmap of (TFreeThreadedDOMDocument60) : Invalid GUID format
//   Error creating palette bitmap of (TXMLSchemaCache60) : Invalid GUID format
//   Error creating palette bitmap of (TXSLTemplate60) : Invalid GUID format
//   Error creating palette bitmap of (TXMLHTTP60) : Invalid GUID format
//   Error creating palette bitmap of (TFreeThreadedXMLHTTP60) : Invalid GUID format
//   Error creating palette bitmap of (TServerXMLHTTP60) : Invalid GUID format
//   Error creating palette bitmap of (TSAXXMLReader60) : Invalid GUID format
//   Error creating palette bitmap of (TMXXMLWriter60) : Invalid GUID format
//   Error creating palette bitmap of (TMXHTMLWriter60) : Invalid GUID format
//   Error creating palette bitmap of (TSAXAttributes60) : Invalid GUID format
//   Error creating palette bitmap of (TMXNamespaceManager60) : Invalid GUID format
// ************************************************************************ //
...
{$ENDIF}
  ...
  CoDOMDocument = CoDOMDocument60;
  CoXMLSchemaCache = CoXMLSchemaCache60;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TDOMDocument60, TFreeThreadedDOMDocument60, TXMLSchemaCache60, TXSLTemplate60, 
