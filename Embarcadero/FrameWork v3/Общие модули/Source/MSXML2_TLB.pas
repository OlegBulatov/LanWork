...
// File generated on 07.08.2020 17:20:03 from Type Library described below.
...
//   Error creating palette bitmap of (TDOMDocument26) : Invalid GUID format
//   Error creating palette bitmap of (TDOMDocument30) : Invalid GUID format
//   Error creating palette bitmap of (TFreeThreadedDOMDocument) : Invalid GUID format
//   Error creating palette bitmap of (TFreeThreadedDOMDocument26) : Invalid GUID format
//   Error creating palette bitmap of (TFreeThreadedDOMDocument30) : Invalid GUID format
//   Error creating palette bitmap of (TXMLSchemaCache) : Invalid GUID format
//   Error creating palette bitmap of (TXMLSchemaCache26) : Invalid GUID format
//   Error creating palette bitmap of (TXMLSchemaCache30) : Invalid GUID format
//   Error creating palette bitmap of (TXSLTemplate) : Invalid GUID format
//   Error creating palette bitmap of (TXSLTemplate26) : Invalid GUID format
//   Error creating palette bitmap of (TXSLTemplate30) : Invalid GUID format
//   Error creating palette bitmap of (TDSOControl) : Invalid GUID format
//   Error creating palette bitmap of (TDSOControl26) : Invalid GUID format
//   Error creating palette bitmap of (TDSOControl30) : Invalid GUID format
//   Error creating palette bitmap of (TXMLHTTP) : Invalid GUID format
//   Error creating palette bitmap of (TXMLHTTP26) : Invalid GUID format
//   Error creating palette bitmap of (TXMLHTTP30) : Invalid GUID format
//   Error creating palette bitmap of (TServerXMLHTTP) : Invalid GUID format
//   Error creating palette bitmap of (TServerXMLHTTP30) : Invalid GUID format
//   Error creating palette bitmap of (TSAXXMLReader) : Invalid GUID format
//   Error creating palette bitmap of (TSAXXMLReader30) : Invalid GUID format
//   Error creating palette bitmap of (TMXXMLWriter) : Invalid GUID format
//   Error creating palette bitmap of (TMXXMLWriter30) : Invalid GUID format
//   Error creating palette bitmap of (TMXHTMLWriter) : Invalid GUID format
//   Error creating palette bitmap of (TMXHTMLWriter30) : Invalid GUID format
//   Error creating palette bitmap of (TSAXAttributes) : Invalid GUID format
//   Error creating palette bitmap of (TSAXAttributes30) : Invalid GUID format
//   Error creating palette bitmap of (TMXNamespaceManager) : Invalid GUID format
// ************************************************************************ //
