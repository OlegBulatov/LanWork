...
// Исправление ошибки возникновения цифры в колонке "Обяз."
...
// Исправление ошибки копирования из Excel
procedure Tfm48_SparkSettings.xxxDBGridKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  // Блокируем кнопку Insert
  if (Key = VK_INSERT) then
  begin
    Abort;
  end else
  // Убираем из буфера обмена пробельные символы в конце перед копированием
