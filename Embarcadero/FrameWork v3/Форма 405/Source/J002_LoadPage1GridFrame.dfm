inherited J002_LoadPage1Grid: TJ002_LoadPage1Grid
  Width = 706
  ...
  inherited odsList: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000000463431375F4944010000000000}
    ...
    object odsListF417_ID: TFloatField
      FieldName = 'F417_ID'
    end
  end
  inherited oqAdd: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  Pk_405_417_data.p_check_all_417_reports(:T055_ID_S, :T055_ID_E' +
        ');'
      'end;')
    Variables.Data = {
  ...
  inherited oqUpdate: TOracleQuery
    SQL.Strings = (
      'begin'
      '  Pk_405_417_data.p_check_417_report(:PACKAGE_ID);'
      'end;')
    Variables.Data = {
  ...
  inherited oqDelete: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  Pk_405_417_data.p_uncheck_all_417_reports(:T055_ID_S, :T055_ID' +
        '_E);'
      'end;')
    Variables.Data = {
      03000000020000000A0000003A543035355F49445F5304000000000000000000
