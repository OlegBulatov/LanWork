...
uses
  ...
  fm020_LookUpFrame, fm033_PeriodFilterFrame, F005_DataPeriodFilterFrame,
  F005_ReporterFilterFrame, fm031_FilterFrame, untParams;

type
  TF005_Opers121 = class(TfmFilteredGrid)
    PeriodFilter: TF005_DataPeriodFilter;
    ReporterFilter: TF005_ReporterFilter;
    actGoToLink: TAction;
    ToolButton1: TToolButton;
    odsListIS_LINKED: TStringField;
    odsListT235_ID: TFloatField;
    odsListT243_ID: TFloatField;
    odsListT055_ID: TFloatField;
    odsListT235_ROW_NUM: TFloatField;
    odsListT028_INN: TStringField;
    odsListT235_EMIT_KPP: TStringField;
    odsListT235_EMIT_OGRN: TStringField;
    odsListT028_COUNTRY_ID: TStringField;
    odsListT027_ID: TFloatField;
    odsListT027_SEC_TYPE: TStringField;
    odsListT026_SEC_REGN: TStringField;
    odsListT235_KODVAL_CB: TStringField;
    odsListT235_N_ST: TFloatField;
    odsListT235_CNT_IN: TFloatField;
    odsListT235_CNT_OUT: TFloatField;
    odsListT235_CNT_DEPO: TFloatField;
...
procedure TF005_Opers121.InitFrame(Sender: TObject);
begin
...
procedure TF005_Opers121.actGoToLinkUpdate(Sender: TObject);
begin
  actGoToLink.Enabled := not odsList.IsEmpty and (odsListIS_LINKED.AsString = 'нет');
end;

procedure TF005_Opers121.actGoToLinkExecute(Sender: TObject);
begin
...
procedure TF005_Opers121.FindData_InPer(const AT055_ID_S,
...
procedure TF005_Opers121.actRefreshExecute(Sender: TObject);
begin
