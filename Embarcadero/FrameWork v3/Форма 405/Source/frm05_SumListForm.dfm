inherited frm05_SumList: Tfrm05_SumList
    ...
    inherited xxxDBGrid: TxxxDBGrid
      ...
      Columns = <
        ...
        item
          ...
          PickList.Strings = ()
          Title.Caption = 'Расчетн. к-во DR1'
          Width = 80
          Visible = True
        end
        item
  ...
  inherited ActionList: TActionList
    ...
    object actCheckIsu: TAction
      Caption = 'Проверка ISU'
      Hint = 'Проверить корректность записей ISU'
      ImageIndex = 19
    ...
    object actSetNotFictive: TAction
      Caption = 'Нефиктивная'
      OnExecute = actSetNotFictiveExecute
      OnUpdate = actSetNotFictiveUpdate
    end
    object actSetUnderQuest: TAction
      Caption = 'Под вопросом'
      OnExecute = actSetUnderQuestExecute
      OnUpdate = actSetUnderQuestUpdate
    end
    object actSetNeedRate: TAction
      Caption = 'Требуется оценка'
      Enabled = False
      Visible = False
  ...
  inherited PopupMenu: TPopupMenu
    ...
    inherited N7: TMenuItem
      object N17: TMenuItem [2]
        Caption = '-'
      end
      object N18: TMenuItem [3]
        Caption = 'Только ошибочные'
        Checked = True
        OnClick = N18Click
      end
    end
  ...
  inherited odsList: TOracleDataSet
    SQL.Strings = (
      ...
      ':ISU_ERR_FILTER')
    Variables.Data = {
      03000000010000000F0000003A4953555F4552525F46494C5445520100000002
      000000200000000000}
    QBEDefinition.QBEFieldDefs = {
      040000006D0000000C000000543030315F504152545F49440100000000000700
      ...
      5353494F4E0100000000000C000000543030315F4953555F4552520100000000
      0008000000543030315F5441580100000000000E000000543030315F5441585F
      43524F5353010000000000}
    ...
    object odsListT001_ISU_ERR: TFloatField
      FieldName = 'T001_ISU_ERR'
    end
    object odsListT001_TAX: TFloatField
      FieldName = 'T001_TAX'
    end
    object odsListT001_TAX_CROSS: TFloatField
      FieldName = 'T001_TAX_CROSS'
    end
  end
  ...
  inherited oqUpdate: TOracleQuery
    SQL.Strings = (
      'BEGIN'
      '  -- выполняем процедуру'
      '  Pk_Hand_Correct_405.P_T001_Sum_Update('
      '    :T001_ID,'
      '    :T002_ID,'
      '    :T001_PART_ID,'
      '    :T001_ROW_PREFIX,'
  ...
  object pmFictive: TPopupMenu
    Left = 848
    Top = 91
    object N_Fictive: TMenuItem
      Action = actSetFictive
    end
    object N_NonFictive: TMenuItem
      Action = actSetNotFictive
    end
    object N_NotCalc: TMenuItem
      Action = actSetUnderQuest
    end
    object N_Unknown: TMenuItem
      Action = actSetNeedRate
    end
    object N_Criteria: TMenuItem
  ...
  object oqSetFictive: TOracleQuery
    ...
    Variables.Data = {
      0300000002000000080000003A543030315F4944040000000000000000000000
      080000003A543033355F4944040000000000000000000000}
    Left = 808
    Top = 355
  end
end
