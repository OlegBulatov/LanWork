inherited B000_Opers14: TB000_Opers14
  ...
  inherited xxxDBGrid: TxxxDBGrid
    ...
    Columns = <
      ...
      item
        ...
        PickList.Strings = ()
        Title.Caption = 
          'Переоценка ценных бумаг - отрицательная (положительная) разница,' +
          ' тыс.руб.'
        Width = 108
        Visible = True
      end
      item
        ...
        PickList.Strings = ()
        Title.Caption = 
          'Корректировка стоимости долговых ц.б. или изменения справедливой' +
          ' стоимости при первоначальном признании долевых ц.б., тыс.руб.'
        Width = 154
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'RESERV_CORR'
        PickList.Strings = ()
        Title.Caption = 'Корректировка резерва на возможные потери, тыс.руб.'
        Width = 83
        Visible = True
      end
      item
  ...
  inherited odsList: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000003300000007000000543035315F49440100000000000E000000543035
      ...
      4F5259010000000000060000005245534552560100000000000E000000505249
      5A5F454D49545F4E52455A01000000000006000000504552454F430100000000
      0004000000434F52520100000000000B0000005245534552565F434F52520100
      00000000}
    ...
    object odsListPEREOC: TFloatField
      FieldName = 'PEREOC'
    end
    object odsListCORR: TFloatField
      FieldName = 'CORR'
    end
    object odsListRESERV_CORR: TFloatField
      FieldName = 'RESERV_CORR'
    end
  end
