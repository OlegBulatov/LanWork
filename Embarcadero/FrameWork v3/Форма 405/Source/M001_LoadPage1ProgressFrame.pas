unit M001_LoadPage1ProgressFrame;
...
type
  TM001_LoadPage1Progress = class(TfmLoader)
  private
  protected
  public
...
var
  M001_LoadPage1Progress: TM001_LoadPage1Progress;
...
procedure TM001_LoadPage1Progress.InitFrame(Sender: TObject);
const
...
procedure TM001_LoadPage1Progress.StartProcess;
begin
  //
  inherited;
end;
