...
type
  ...
  private
    ...
    FParamValue: string;  // значение параметра при вызове процедуры
    FMustBe: string;      // обязательно наличие колонки в файле Excel (Y/N)
  protected
  ...
  public
    ...
    property MustBe: string read FMustBe write FMustBe;
  end;
