inherited F005_LoadPage3aGrid: TF005_LoadPage3aGrid
  ...
  inherited odsList: TOracleDataSet
    SQL.Strings = (
      ...
      '       LOAD_ERRORS,'
      '       LOAD_COMMENT'
      'FROM   V_405_415_LOAD_RESULT'
      'WHERE  T245_ID = :T245_ID')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0C0000004C4F41445F434F4D4D454E5401000000000007000000543234355F49
      44010000000000}
    ...
    object odsListT245_ID: TFloatField
      FieldName = 'T245_ID'
    end
  end
end
