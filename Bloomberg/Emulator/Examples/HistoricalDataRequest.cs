...
namespace Examples
{
    ...
    public static class HistoricalDataRequest
    {
        ...
        private static readonly Name _nAsk = new Bloomberglp.Blpapi.Name("ASK");
        private static readonly Name _nBid = Bloomberglp.Blpapi.Name.GetName("BID");
        private static readonly Name _nSecurities = Bloomberglp.Blpapi.Name.GetName("securities");

        public static void RunExample()
        {
            Bloomberglp.Blpapi.Name x = new Bloomberglp.Blpapi.Name();
