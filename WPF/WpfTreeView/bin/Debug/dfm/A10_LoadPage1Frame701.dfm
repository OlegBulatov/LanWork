inherited A10_LoadPage1_701: TA10_LoadPage1_701
  Width = 668
  Height = 557
  ...
  inherited PanelStepBody: TPanel
    Width = 668
    Height = 505
    inline Grid: TA10_LoadPage1_701Grid
      Top = 71
      Width = 668
      Height = 434
      Align = alClient
    ...
    inline Filters: TA10_LoadPage1_701Filters
      Width = 668
      Align = alTop
      TabOrder = 1
  ...
  object odsLastLoad: TOracleDataSet
    SQL.Strings = (
      ...
      'FROM   DPB_701_BOSS.V_701_LAST_LOAD')
  ...
  object oqReload: TOracleQuery
    SQL.Strings = (
      'begin'
      '  DPB_701_BOSS.Pk_701_Load.p_refresh_gci_data;'
      'end;')
    Session = dmMain.OracleSession
    Left = 400
    Top = 16
