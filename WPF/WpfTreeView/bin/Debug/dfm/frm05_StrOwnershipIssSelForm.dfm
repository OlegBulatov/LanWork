inherited frm05_StrOwnershipIssSel: Tfrm05_StrOwnershipIssSel
  Left = 277
  Top = 246
  ...
  inherited ActionList: TActionList
    ...
    object actShowDiv: TAction
      Caption = 'Дивиденды'
      Checked = True
      OnExecute = actShowDivExecute
    end
    object actShowReinv: TAction
      Caption = 'Реинвестированные доходы'
      OnExecute = actShowReinvExecute
    end
    object actShowAllDiv: TAction
      Caption = 'Всех'
      OnExecute = actShowAllDivExecute
    end
  end
  inherited PopupMenu: TPopupMenu
    ...
    object N5: TMenuItem [8]
      ...
      object N10: TMenuItem
        Action = actShowAllDiv
        Caption = 'Всё'
      end
    end
    object mi10: TMenuItem [9]
      Caption = 'Показывать...'
      object N2: TMenuItem
        Action = actShowRez
      end
  ...
  inherited odsList: TOracleDataSet
    SQL.Strings = (
      ...
      '    :T025_ID, '
      '    0, T025_ID, '
      '    9, DECODE(T025_ID, 29, 29, 1, 1, 9), '
      '    8'
      '  )'
      
        'AND M029_IS_DIV = DECODE(:M029_IS_DIV, -1 , M029_IS_DIV, :M029_I' +
        'S_DIV)'
      
        'AND M029_IS_REINV = DECODE(:M029_IS_REINV, -1 , M029_IS_REINV, :' +
        'M029_IS_REINV)'
      ''
      ...
      ' ')
    Variables.Data = {
      0300000003000000080000003A543032355F4944040000000000000000000000
      0C0000003A4D3032395F49535F4449560400000000000000000000000E000000
      3A4D3032395F49535F5245494E56040000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000001700000007000000543032385F49440100000000000E000000543032
      ...
      00000A000000543033365F43525F49440100000000000B0000004D3032395F49
      535F4449560100000000000D0000004D3032395F49535F5245494E5601000000
      000010000000543032385F524547494F4E5F434F44450100000000000B000000
      543032385F524547494F4E010000000000}
    ...
    object odsListM029_IS_DIV: TIntegerField
      FieldName = 'M029_IS_DIV'
      Required = True
    end
    object odsListM029_IS_REINV: TIntegerField
  ...
  inherited oqAdd: TOracleQuery
    SQL.Strings = (
      ...
      '  v_rec.T028_REGION_CODE := :T028_REGION_CODE;'
      ...
      '  v_M029_rec.M029_IS_DIV := :M029_IS_DIV;'
      '  v_M029_rec.M029_IS_REINV := :M029_IS_REINV;'
      '  PK_NResident.p_iss_sel_add(v_M029_rec);'
      'END;'
      ' '
      '')
    Variables.Data = {
      }
  end
  inherited oqUpdate: TOracleQuery
    SQL.Strings = (
      ...
      '  v_M029_rec.M029_IS_DIV := :M029_IS_DIV;'
      '  v_M029_rec.M029_IS_REINV := :M029_IS_REINV;'
      '  PK_NResident.p_iss_sel_edit(v_M029_rec);'
      'END;')
    Variables.Data = {
      0300000011000000080000003A543032385F4944040000000000000000000000
      ...
      00000000000C0000003A4D3032395F49535F4449560400000000000000000000
      000E0000003A4D3032395F49535F5245494E5604000000000000000000000011
      0000003A543032385F524547494F4E5F434F4445040000000000000000000000}
  end
