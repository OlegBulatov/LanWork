inherited frm47_IssuerGroupTop: Tfrm47_IssuerGroupTop
  Left = 198
  Top = 243
  Caption = 'Эмитенты, не входящие в группу'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited odsList: TOracleDataSet
    SQL.Strings = (
      ...
      #9'   V1.T025_ID,'
      #9'   V1.T025_SHOT_NAME,'
      #9'   V1.T036_TICKER_SKRIN,'
      #9'   V1.T036_MAIL_ADDRESS,'
      #9'   V1.T036_REG_NUMBER,'
      #9'   V1.T036_COMPANY_HEAD,'
      #9'   V1.T028_COUNTRY_ID,'
      #9'   V1.COUNTRY_NAME,'
      #9'   V1.T028_CODE'
      'FROM   V_405_ISSUER_PARENT V1'
      'WHERE  NOT EXISTS ('
      '                  SELECT NULL'
      '                  FROM   T043_ISSUER_GROUP_LINK V2'
      '                  WHERE  V1.T028_ID = V2.T028_ID'
      '                  AND    v2.T042_ID = :T042_ID'
      '                  )'
      ' ')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000D000000543033365F494E4455535452590100000000000F00000054303238
      5F434F554E5452595F49440100000000000C000000434F554E5452595F4E414D
      4501000000000009000000543032385F434F4445010000000000}
