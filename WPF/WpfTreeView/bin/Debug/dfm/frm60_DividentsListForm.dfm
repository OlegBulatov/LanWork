inherited frm60_DividentsList: Tfrm60_DividentsList
    ...
    inherited xxxDBGrid: TxxxDBGrid
      ...
      Columns = <
        ...
        item
          ...
          PickList.Strings = ()
          Title.Caption = 'Долевой / Долговой'
          Width = 65
          Visible = True
        end>
    end
  ...
  inherited odsList: TOracleDataSet
    SQL.Strings = (
      ...
      'AND T027_ID = :T027_ID')
    Variables.Data = {
      0300000002000000080000003A543032385F4944030000000400000001000000
      00000000080000003A543032375F494404000000080000000000000000000840
      00000000}
    QBEDefinition.QBEFieldDefs = {
      0400000029000000070000004D3035305F494401000000000007000000543032
      ...
      00000000000E0000004D3035305F544F4F4C5F545950450100000000000E0000
      00544F4F4C5F545950455F44455343010000000000}
    ...
    object odsListM050_TOOL_TYPE: TIntegerField
      FieldName = 'M050_TOOL_TYPE'
      Required = True
    end
  ...
  inherited oqAdd: TOracleQuery
    SQL.Strings = (
      ...
      '  v_rec.M050_TOOL_TYPE := :M050_TOOL_TYPE;'
      ''
    ...
    Variables.Data = {
      ...
      35305F545950450500000000000000000000000F0000003A4D3035305F544F4F
      4C5F54595045040000000000000000000000}
    Left = 112
    Top = 200
  end
  inherited oqUpdate: TOracleQuery
    SQL.Strings = (
      ...
      ' ')
    Variables.Data = {
      030000000E000000080000003A4D3035305F4944040000000000000000000000
      ...
      0000000F0000003A4D3035305F544F4F4C5F5459504504000000000000000000
      0000}
  end
